    ...
    {setResultsTable => (
      <Query query={GET_RESULTS_TABLE}>
        {({
          ...
          const {
            classes,
            queryState: { called, loading, data: query, error },
          } = props;
          ...
          if (resultsTable.orderBy) {
            dataset = results.data.sort(
              getSorting(resultsTable.order, resultsTable.orderBy),
            );
          } else {
              ...
              <div className={classes.tableWrapper}>
                <Table className={classes.table} aria-labelledby="tableTitle">
                  ...
                  <TableBody>
                    {dataset
                      .slice(
                        resultsTable.page * resultsTable.rowsPerPage,
                        resultsTable.page * resultsTable.rowsPerPage +
                          resultsTable.rowsPerPage,
                      )
                      .map((row, rIndex) => (
